...
import { getUserPlanInfo, getProfileData } from '@/lib/actions/profile';
...
export default async function PerfilPage() {
  const [planInfo, profileData] = await Promise.all([getUserPlanInfo(), getProfileData()]);

  if (!planInfo) redirect('/login');
