  ...
  return (
    <div className="p-8">
      ...
      <div className="bg-white rounded-xl border border-black/[0.08] shadow-[0_2px_8px_rgba(0,0,0,0.04)] overflow-hidden">
        {/* Header */}
        <div className="grid grid-cols-[1fr_auto_auto_auto] gap-4 px-6 py-3 bg-slate-50 border-b border-black/[0.06] text-xs font-semibold text-slate-400 uppercase tracking-wide">
          <span>Email</span>
        ...
        {users.length === 0 ? (
          ...
          <div className="divide-y divide-black/[0.04]">
            {users.map(user => (
              <div key={user.id} className="grid grid-cols-[1fr_auto_auto_auto] gap-4 items-center px-6 py-3.5 hover:bg-slate-50/50 transition-colors">
